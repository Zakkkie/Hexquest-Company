...
export const TEXT: Record<Language, Dictionary> = {
    EN: {
        ...
        TUTORIAL: {
            ...
            CAMERA_DESC: "Rotate Camera",
            MOVE_A: "Select Sector A",
            MOVE_B: "Select Sector B",
            MOVE_CENTER: "Return to Center",
            ACQUIRE: "Acquire",
            UPGRADE_L2: "Upgrade L2",
            ...
            FOUNDATION_TASK: "Task: Cycle upgrades to clear the queue and build the foundation.",
            FINAL_TITLE: "Foundation Secure!",
            FINAL_DESC: "Return to the center and upgrade to Level 3.",
    ...
    RU: {
        ...
        TUTORIAL: {
            ...
            MOVE_A: "Выберите Сектор А",
            MOVE_B: "Выберите Сектор Б",
            MOVE_CENTER: "Вернуться в Центр",
            ACQUIRE: "Захват",
            UPGRADE_L2: "Улучшить (Ур.2)",
            ...
            FOUNDATION_TASK: "Задача: Улучшайте соседей, чтобы создать фундамент.",
